...
//        TestRailApiWrapper::$testrail_log_results = $testrail_log_results;
        ...
        TestRailApiWrapper::$testrail_testrun_name = date("d-m-Y H:i:s") . $where_ws_test_run . " Fox PHP " .  " " . $testrail_testrun_name; // test rail run name to include type of Local run
